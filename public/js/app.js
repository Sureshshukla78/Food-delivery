...
function placeOrder(formObj) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/order", formObj).then(function (response) {
...
function updateStatus(order) {
  ...
  statuses.forEach(function (item) {
    var dataProp = item.dataset.status;
...
if (order) {
  socket.emit('join', "order_".concat(orderObj._id));
}
...
socket.on('orderUpdated', function (data) {
  var updatedOrder = _objectSpread({}, orderObj);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51LkDDPSEWJV86oOmqt2xLlbaGuBvxeotIiGfYkbiyZjUe0tAcsVCBA8rxF6QsmJScrlL6wNvRsVDiZ3R77yWAUGr009keT6ZDM');
            ...
            if (paymentForm) {
              paymentForm.addEventListener('submit', function (e) {
                ...
                if (!card) {
                  ...
                  (0,_apiService__WEBPACK_IMPORTED_MODULE_2__.placeOrder)(formObj);
                  return;
                } // 1. verify card


                stripe.createToken(card).then(function (result) {
                  formObj["stripeToken"] = result.token.id; // console.log(formObj);
